import { ProductSchema, ProductFormDataType } from "./product.zod";

describe("ProductSchema | 성공 케이스", () => {
  it("should validate a valid product form data", () => {
    const validProductFormData: ProductFormDataType = {
      categoryId: 1,
      name: "Product Name",
...
describe("ProductSchema | 실패 케이스", () => {
  it("카테고리 미선택", () => {
    const invalidProductFormData: ProductFormDataType = {
      categoryId: 0,
      name: "Product Name",
      desc: "Product Description",
      price: 1000,
